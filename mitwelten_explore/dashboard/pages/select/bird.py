...
def get_deployment_select_data():
    deployments = get_deployments(type_query="audio")
    return [
        {
                ...
                [
                    dmc.Col(
                        children=[
                            ...
                            dmc.MultiSelect(
                                ...
                                label="Deployment",
                                description="Select one or more deployments to be included in the dataset",
                    ...
                    dmc.Col(
                        [
                            dmc.Space(h=12),
                            dmc.LoadingOverlay(
                                id=ids.dataset_card_div,
                                children=bird_dataset_card(
                                    id_role=ids.add_trace,
                                    deployment_ids=None,
                                ),
                            ),
                        ],
...
def update_ds_card(deployments):
    return bird_dataset_card(
        id_role=ids.add_trace,
